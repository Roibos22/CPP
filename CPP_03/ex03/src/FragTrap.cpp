...
/*   Updated: 2024/02/18 16:10:27 by lgrimmei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	FragTrap::attack(const std::string& target)
{
	...
	else
	{
		...
		std::cout << this->getTrapType() << this->getName() << " attacks " << target << ", causing " << this->getAttackDamage() << " points of damage! What a strike! Ouch!" << std::endl;
	}
}
